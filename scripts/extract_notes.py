...
df = pd.read_csv('/mnt/nfs/scratch1/iman/data/data/physionet.org/files/mimiciii/1.4/NOTEEVENTS.csv')
...
#dataset_path = '/mnt/nfs/scratch1/iman/data/data/physionet.org/files/mimic3-benchmarks/MIMIC/root/test/'
dataset_path = '/mnt/nfs/scratch1/iman/data/data/physionet.org/files/mimic3-benchmarks/MIMIC/root/train/'
all_files = os.listdir(dataset_path)
all_folders = list(filter(lambda x: x.isdigit(), all_files))

#output_folder = '/mnt/nfs/scratch1/iman/data/data/physionet.org/files/mimic3-benchmarks/MIMIC/root/test_text_fixed/'
output_folder = '/mnt/nfs/scratch1/iman/data/data/physionet.org/files/mimic3-benchmarks/MIMIC/root/text_fixed/'
